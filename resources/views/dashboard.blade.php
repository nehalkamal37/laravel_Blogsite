...
<img class="brand-img d-inline-block" src="{{ asset('"dist/img/logo-light.png') }}" alt="brand" />
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="hk-legend-wrap mt-10">
											...
											<div class="hk-legend">
												<span class="d-10 bg-neon-light-1 rounded-circle d-inline-block"></span><span>B-2</span>
											</div>
											<div class="hk-legend">
												<span class="d-10 bg-neon-light-2 rounded-circle d-inline-block"></span><span>C-3</span>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="card">
											...
											<div class="card-body">
												...
												<div class="hk-legend-wrap mt-10">
													...
													<div class="hk-legend">
														<span class="d-10 bg-neon-light-2 rounded-circle d-inline-block"></span><span>Tablet</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card">
											...
											<div class="card-body">
												...
												<div class="hk-legend-wrap mt-10">
													...
													<div class="hk-legend">
														<span class="d-10 bg-neon-light-1 rounded-circle d-inline-block"></span><span>Yesterday</span>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="table-wrap">
									<div class="table-responsive">
										<table class="table table-hover mb-0">
											...
											<tbody>
												<tr>
													<td><img class="circle" src="{{ asset('"dist/img/logo5.jpg') }}" alt="icon"></td>
													<td>Fakebook</td>
												...
												<tr>
													<td><img class="circle" src="{{ asset('"dist/img/logo2.jpg') }}" alt="icon"></td>
													<td>Microhard</td>
												...
												<tr>
													<td><img class="circle" src="{{ asset('"dist/img/logo3.jpg') }}" alt="icon"></td>
													<td>Oesla Motors</td>
												...
												<tr>
													<td><img class="circle" src="{{ asset('"dist/img/logo4.jpg') }}" alt="icon"></td>
													<td>NVISION</td>
	...
	<script src="{{ asset('dash/dist/js/dashboard5-data.js') }}"></script>
