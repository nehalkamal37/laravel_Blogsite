...
<body>
<a href="{{ route('dashboard.settings.index')}}">dashboard</a>
    <div id="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="topsearch text-right">
                            ...
                            <i class="fa fa-search"></i>{{ $properties['native']}}</a>
                            @endforeach
                        </div><!-- end search -->
                    </div><!-- end col -->
                </div><!-- end row -->
        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
       <a href="garden-index.html"><img src="{{ $setting->favicon}}">
     {{--   <img src="{{ asset('front/images/version/garden-logo.png')}}" alt="">
    --}}</a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="index.html"><img src="{{ asset('front/images/version/garden-footer-logo.png')}}" alt="" class="img-fluid"></a>
