...
@csrf
 ...
 <div class="form-control text-truncate" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div>
        ...
        <option @selected(old('parent_id')== $cat->id) value="{{ $cat->id}}">{{$cat->getTranslationsArray()['en']['title']}}</option>
                                 @endforeach
                                </select>
...
<div class="input-group">
    ...
    <input type="text" name="{{$localeCode}}[title]" class="form-control" aria-label="Default"
     aria-describedby="inputGroup-sizing-default">
        ...
        <textarea class="form-control mt-15 ck-edit"  placeholder="content..." name="{{$localeCode}}[content]" rows="3" ></textarea>
        @error("{{$localeCode}}[content]")
        <span>{{$message}}</span>
        @enderror   
        </div>
<div>
    <textarea class="form-control mt-15 ck-edit" placeholder="small description" name="{{$localeCode}}[small_description]" rows="3" ></textarea>
...
<div>
    ...
    name="{{$localeCode}}[tags]" rows="3" ></textarea>
